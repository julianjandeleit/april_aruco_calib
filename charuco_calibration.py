...
mtx, dist = get_calibration_parameters(img_dir=PATH_TO_YOUR_IMAGES)
...
image_path = [os.path.join(PATH_TO_YOUR_IMAGES, f) for f in os.listdir(PATH_TO_YOUR_IMAGES) if f.endswith(".JPG")][4] # NOTE select image to calculate size
